...
class MedicalTriageEnv(
    ...
    Example:
        ...
        ...
        ...     result = client.step(MedicalTriageAction(message="Hello!"))
        ...     print(result.observation.echoed_message)
    ...
    def _step_payload(self, action: MedicalTriageAction) -> Dict:
        """
        Convert MedicalTriageAction to JSON payload for step message.

        Args:
            action: MedicalTriageAction instance
    ...
    def _parse_result(self, payload: Dict) -> StepResult[MedicalTriageObservation]:
        """
        Parse server response into StepResult[MedicalTriageObservation].

        Args:
            payload: JSON response data from server

        Returns:
            StepResult with MedicalTriageObservation
        """
